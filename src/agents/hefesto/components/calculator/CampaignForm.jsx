...
//
// REFINAMIENTO FASE 2.3: "País" pasó a ser ReadOnly (autocompletado desde
// la campaña elegida). CORRECCIÓN FASE 2.4 ("DEBUGGING DE UI Y PARSEO DE
// DATOS", reporte de QA: el selector de País estaba bloqueado y el
// dropdown de campañas mezclaba todos los países): "País" VUELVE a ser un
// <select> editable, elegido ANTES que la campaña — el dropdown de
// "Nombre de la campaña" se filtra por el país elegido (ver
// `useCampaignCalculator.availableProcessedCampaigns`). "Fecha de envío"
// SÍ se mantiene ReadOnly (eso no era el bug reportado): se autocompleta
// desde `communication_start_date` de la campaña elegida y no se puede
// editar a mano, para garantizar consistencia con la consulta a Metabase.
  ...
  return (
    <div className="rounded-card bg-card p-6 shadow-card">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <Field label="País" hint="Elige el país primero para filtrar las campañas disponibles.">
          <select
